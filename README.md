...
*   **Topological Admissibility ($\mathcal{C}_{\mathrm{id}}$ & $\hat{\mathcal{C}}_{\mathrm{top}}$):** Enforces strict mathematical admissibility criteria on the substrate $\mathcal{S}$, eliminating non-physical ghost degrees of freedom.
